...
const styles = tv({
  base: 'font-sans bg-[var(--bg-elevated)] dark:backdrop-blur-2xl dark:backdrop-saturate-200 forced-colors:bg-[Canvas] shadow-2xl rounded-xl bg-clip-padding border border-[var(--border)] text-neutral-700 dark:text-neutral-300 outline-0',
  variants: {
    isEntering: {
