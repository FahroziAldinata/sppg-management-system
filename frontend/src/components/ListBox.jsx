  ...
  return (
    <AriaListBox
      ...
      className={composeTailwindRenderProps(
        props.className,
        'outline-0 p-1 w-[200px] bg-[var(--bg-elevated)] border border-[var(--border)] rounded-lg font-sans'
      )}>
      {children}
    </AriaListBox>
  );
...
export const itemStyles = tv({
  ...
  variants: {
    isSelected: {
      ...
      true: 'bg-[var(--input-focus-border)] text-white forced-colors:bg-[Highlight] forced-colors:text-[HighlightText] [&:has(+[data-selected])]:rounded-b-none [&+[data-selected]]:rounded-t-none -outline-offset-4 outline-white dark:outline-white forced-colors:outline-[HighlightText]'
    },
    isDisabled: {
...
export const dropdownItemStyles = tv({
  ...
  variants: {
    ...
    isFocused: {
      true: 'bg-[var(--input-hover-border)] text-white'
    },
    isSelected: {
      true: 'bg-[var(--input-focus-border)] text-white font-semibold'
    }
  },
  compoundVariants: [
    {
